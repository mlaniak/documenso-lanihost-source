...
const SOURCE_CODE_URL = 'https://github.com/mlaniak/documenso-lanihost-source';
    ...
    <html translate="no" lang={lang} data-theme={theme} className={theme ?? ''}>
      ...
      <body className={isRecipientRoute ? 'documenso-branded' : undefined}>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="fixed right-3 bottom-3 z-50 rounded-md border bg-background/95 px-2 py-1 text-[11px] text-muted-foreground shadow-sm backdrop-blur hover:text-foreground"
        >
